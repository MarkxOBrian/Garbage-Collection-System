            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="<?= $userprofile; ?>" class="rounded-circle" width="150" alt="profile photo" />
                                    <h4 class="card-title m-t-10"><?= $usern; ?></h4>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                <h6><?= $usere; ?></h6> <small class="text-muted p-t-30 db">Location</small>
                                <h6><?= $userl; ?></h6> <small class="text-muted p-t-30 db">Category</small>
                                <h6><?= $usercat; ?></h6>
                                <div class="map-box">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="<?= $usercat; ?>" class="form-control form-control-line" readonly="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Description</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="<?= $userd; ?>" class="form-control form-control-line" readonly="">
                                        </div>
                                    </div>
                                </form>
                            </div>
