...
$countSql2 = $db->query("SELECT * FROM orders WHERE company_name = '$usern'");
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <?php 
                            $sql2 = "SELECT * FROM orders WHERE company_name = '$usern'";
                            $result2 = $db->query($sql2);
                             ?>
                            <div class="card-body">
                                <h4 class="card-title">Orders for <?= $usern; ?></h4>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="adminindex.php?deleteo=<?=$order['order_id']; ?>" class="btn btn-danger btn-xs" >Delete</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                    </tbody>
